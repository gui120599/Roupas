        ...
        <div class="grid grid-cols-1 gap-x-4 gap-y-2 md:grid-cols-6">
            <div class="md:col-span-full grid grid-cols-1 md:grid-cols-6 gap-x-4 gap-y-4">
                <div class="col-span-1 md:col-span-4 space-y-3">
                    <div class="md:col-span-4">
                        ...
                        <x-input-error :messages="$errors->updatePassword->get('cliente_nome')" class="mt-2" />
                    </div>
                    <div class="md:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                        <div class="col-span-1">
                            ...
                            <x-input-error :messages="$errors->updatePassword->get('cliente_data_nascimento')" class="mt-2" />
                        </div>
                        <div class="col-span-1">
                        ...
                        <div id="fisica" class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                            <div class="">
                                ...
                                <x-text-input id="cliente_cpf" name="cliente_cpf" type="text" class="cpf mt-1 w-full"
                                    autocomplete="off" autofocus />
                                <x-input-error :messages="$errors->updatePassword->get('cliente_cpf')" class="mt-2" />
                            </div>
                            <div class="">
                                <x-input-label for="cliente_rg" :value="__('RG')" />
                                <x-text-input id="cliente_rg" name="cliente_rg" type="text" class="rg mt-1 w-full"
                                    autocomplete="off" autofocus />
                                <x-input-error :messages="$errors->updatePassword->get('cliente_rg')" class="mt-2" />
                            </div>
                        </div>
                        <div id="juridica" class="hidden md:col-span-2">
                            ...
                            <x-text-input id="cliente_cnpj" name="cliente_cnpj" type="text" class="cnpj mt-1 w-full"
                                autocomplete="off" autofocus />
                            <x-input-error :messages="$errors->updatePassword->get('cliente_cnpj')" class="mt-2" />
                        </div>
                    </div>
                </div>
            ...
            <div class="md:col-span-full grid grid-cols-1 md:grid-cols-6 gap-x-4 gap-y-4">
                <div class="lg:col-span-3 md:col-span-4">
                    ...
                    <x-input-error :messages="$errors->updatePassword->get('cliente_celular')" class="mt-2" />
                </div>
                <div class="lg:col-span-3 md:col-span-4">
                    <x-input-label for="cliente_email" :value="__('E-mail')" />
                    <x-text-input id="cliente_email" name="cliente_email" type="text"
                        class="mt-1 w-full" autocomplete="off" placeholder=""/>
                    <x-input-error :messages="$errors->updatePassword->get('cliente_email')" class="mt-2" />
                </div>
            ...
            <div class="md:col-span-full grid grid-cols-1 md:grid-cols-6 gap-x-4 gap-y-4">
                <div class="lg:col-span-6 md:col-span-6">
                    ...
                    <x-text-input id="cliente_endereco" name="cliente_endereco" type="text"
                        class="mt-1 w-full" autocomplete="off" />
                    <x-input-error :messages="$errors->updatePassword->get('cliente_endereco')" class="mt-2" />
                </div>

                <div class="lg:col-span-1 md:col-span-3">
                    <x-input-label for="cliente_bairro" :value="__('Bairro')" />
                    <x-text-input id="cliente_bairro" name="cliente_bairro"
                        type="text" class="cep mt-1 w-full" autocomplete="off" />
                    <x-input-error :messages="$errors->updatePassword->get('cliente_bairro')" class="mt-2" />
                </div>

                <div class="lg:col-span-1 md:col-span-3">
                    <x-input-label for="cliente_cidade" :value="__('Cidade')" />
                    <x-text-input id="cliente_cidade" name="cliente_cidade"
                        type="text" class="mt-1 w-full" autocomplete="off" />
                    <x-input-error :messages="$errors->updatePassword->get('cliente_cidade')" class="mt-2" />
                </div>
                ...
                <div class="lg:col-span-1 md:col-span-3">
                    ...
                    <x-text-input id="cliente_estado" name="cliente_estado" type="text"
                        class="mt-1 w-full" autocomplete="off" />
                    <x-input-error :messages="$errors->updatePassword->get('cliente_estado')" class="mt-2" />
                </div>

                <div class="lg:col-span-1 md:col-span-3">
                    <x-input-label for="cliente_cep" :value="__('CEP')" />
                    <x-text-input id="cliente_cep" name="cliente_cep"
                        type="text" class="cep mt-1 w-full" autocomplete="off" />
                    <x-input-error :messages="$errors->updatePassword->get('cliente_cep')" class="mt-2" />
                </div>
            </div>
