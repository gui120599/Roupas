<section>
    ...
    <form action="{{ route('produto.store') }}" method="post" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="produto_descricao" name="produto_descricao" type="text" class="mt-1 w-full" autocomplete="off" autofocus />
        ...
        <div>
            ...
            <x-text-input id="produto_codigo_barras" name="produto_codigo_barras" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_referencia" name="produto_referencia" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-file-input id="produto_foto" name="produto_foto" class="mt-1 w-full" />
        ...
        <div>
            ...
            <x-text-input id="produto_preco_custo" name="produto_preco_custo" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_valor_percentual_venda" name="produto_valor_percentual_venda" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_preco_venda" name="produto_preco_venda" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_valor_percentual_comissao" name="produto_valor_percentual_comissao" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_preco_comissao" name="produto_preco_comissao" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_preco_promocional" name="produto_preco_promocional" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_quantidade_minima" name="produto_quantidade_minima" type="text" class="mt-1 w-full" autocomplete="off" />
        ...
        <div>
            ...
            <x-text-input id="produto_quantidade_maxima" name="produto_quantidade_maxima" type="text" class="mt-1 w-full" autocomplete="off" />
